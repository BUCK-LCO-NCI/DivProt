...
psiblast -query "../$QUERYFILE" -subject "../$SUBJECTFILE" -outfmt 6 -evalue 1000 > PSIBLAST_results.txt
...
#also note though that while e-val 100 is almost comical, in our testing of short (20-55), divergent seqs, even e-val 1000 is too strict...as is 10,000. Just keep in mind your data and what can be done with it
